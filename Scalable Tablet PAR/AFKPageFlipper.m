...
- (void) initFlip {
	...
	if (flipDirection == AFKPageFlipperDirectionRight) {
		...
		if (pageDifference > 1) {
			...
			[blankViewFLeft setBackgroundColor:[UIColor blackColor]];
			...
			[blankViewBRight setBackgroundColor:[UIColor blackColor]];
		...
		//	//[blankViewFLeft release];
			...
			[blankViewFLeft2 setBackgroundColor:[UIColor blackColor]];
			...
			[blankViewBRight2 setBackgroundColor:[UIColor blackColor]];
		...
		if (pageDifference > 1) {
			...
			[blankViewBLeft setBackgroundColor:[UIColor blackColor]];
			...
			[blankViewFRight setBackgroundColor:[UIColor blackColor]];
...
//			[blankViewBLeft release];
			...
			[blankViewBLeft2 setBackgroundColor:[UIColor whiteColor]];
			...
			[blankViewFRight2 setBackgroundColor:[UIColor whiteColor]];
